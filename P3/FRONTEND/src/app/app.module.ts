...
import { ContractorProfileComponent } from './component/customer-profile/customer-profile.component';
...
@NgModule({
 ...
 // {path: 'component/contractor-profile', component: ContractorProfileComponent},
  {path: 'component/customer-profile', component: ContractorProfileComponent},
